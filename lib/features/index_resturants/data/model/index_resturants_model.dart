...
//
//     final indexRestaurantModel = indexRestaurantModelFromJson(jsonString);

import 'dart:convert';

IndexRestaurantModel indexRestaurantModelFromJson(String str) =>
    IndexRestaurantModel.fromJson(json.decode(str));

String indexRestaurantModelToJson(IndexRestaurantModel data) =>
    json.encode(data.toJson());

class IndexRestaurantModel {
  bool? success;
  String? message;
  Data? data;
  ...
  factory IndexRestaurantModel.fromJson(Map<String, dynamic> json) =>
      IndexRestaurantModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        resturants: json["resturants"] == null
            ? []
            : List<Resturant>.from(
  ...
  Map<String, dynamic> toJson() => {
        "resturants": resturants == null
            ? []
            : List<dynamic>.from(resturants!.map((x) => x.toJson())),
        "count": count,
      };
}
...
class Resturant {
  ...
  factory Resturant.fromJson(Map<String, dynamic> json) => Resturant(
        ...
        adminResturant: json["adminResturant"] == null
            ? null
            : AdminResturant.fromJson(json["adminResturant"]),
